...
* **Полиморфизм** - возможность функцци работать с данными разных типов. Позволяет использовать один и тот же код для различных объектов, 
имеющих один и тот же интерфейс, но обладающих различной реализацией. Блягодаря полиморфизму можно работать с классом-потомком точно так же, 
...
* **Инкапсуляция** - имеет 2 трактовки: 
    1) Объединения в один объект данных и методов, которые работают с этими данными
    2) Возможность защитить некоторые данные от несанкционированного доступа. 
    Сокрытие внутренней структуры от внешнего мира, состояние объекта может изменить только сам объект 
Эта парадигма позволяет упаковать все данные и функции в некоторый единый компонент.
